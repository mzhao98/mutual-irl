...
def run_k_rounds(exp_num, task_reward, h_alpha=0.0):
    ...
    robot = Robot(robot_rew, None, starting_objects, permutes=permutes, vi_type='cvi', is_collaborative_human=False)
...
def run_experiment():
    ...
    # show the plot
    fig.tight_layout()
    plt.savefig("cirl_100_violin.png")
    plt.show()
    plt.close()
    ...
    plt.legend()
    plt.savefig("cirl_100_by_round_Std.png")
    plt.show()
