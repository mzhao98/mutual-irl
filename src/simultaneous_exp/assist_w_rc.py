...
def run_experiment():
    ...
    plt.title('Assistance w/ Hidden RC', fontsize=16)
    plt.plot(X, Y, label='Diff PDF')
    plt.plot(X, CY, 'r--', label='Diff CDF')
    plt.xlabel("% of Opt CVI - % of Opt StdVI")

    plt.legend()
    plt.savefig("simultaneous_assistance_100_cdf.png")
    plt.show()
    plt.close()
    ...
    # show the plot
    fig.tight_layout()
    plt.savefig("simultaneous_assistance_100_violin.png")
    plt.show()
    plt.close()
    ...
    fig.tight_layout()
    plt.savefig("simultaneous_assistance_100_bar.png")
    plt.show()
    plt.close()
