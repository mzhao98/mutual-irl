...
def run_k_rounds(exp_num, task_reward, h_alpha=0.0):
    ...
    robot = Robot(robot_rew, human_rew, starting_objects, permutes=permutes, vi_type='cvi', is_collaborative_human=False)
    ...
    robot = Robot(robot_rew, human_rew, starting_objects, permutes=permutes, vi_type='stdvi', is_collaborative_human=False)
    human = Greedy_Human(human_rew, robot_rew, starting_objects, h_alpha)
    robot.setup_value_iteration()
    env = Simultaneous_Cleanup(robot, human, starting_objects)
