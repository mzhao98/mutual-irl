...
from src.simultaneous_exp.saved_versions.collab_robot import Robot
...
def run_k_rounds(exp_num, task_reward, h_alpha=0.0):
    ...
    human = Robot(human_rew, robot_rew, starting_objects, vi_type='cvi')
...
def run_experiment():
    ...
    plt.legend()
    plt.savefig("cirl_w_rc_10_cdf.png")
    plt.show()
