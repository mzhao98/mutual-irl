...
class Robot:
    ...
    def get_human_action_under_hypothesis_bsp(self, current_state_remaining_objects, human_reward):
        # print("human_reward", human_reward)
        possible_h_action_to_prob = self.get_human_action_under_collaborative_hypothesis_bsp(current_state_remaining_objects, human_reward)

        return possible_h_action_to_prob

    def get_human_action_under_collaborative_hypothesis_bsp(self, current_state_remaining_objects, human_reward):
    ...
    def act(self, state, is_start=False, round_no=0, use_exploration=False, boltzman=False, epsilon=0.1):
        ...
        for h_reward_idx in self.beliefs:
            ...
            possible_human_action_to_prob = self.get_human_action_under_hypothesis_bsp(current_state, h_reward_hypothesis)
            # print("possible_human_action_to_prob", possible_human_action_to_prob)
            # print("probability_of_hyp", probability_of_hyp)
