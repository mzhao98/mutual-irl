...
class OptimalMDP:
    ...
    def compute_max_human_reward(self):
        # print("policy", policy)

        num_objs = sum(self.start_state)
        if num_objs % 2 == 0:
            num_human_actions = int(num_objs / 2)
        else:
            num_human_actions = int(num_objs / 2)
        ...
        # print("self.human_rew = ", self.human_rew)
        # print("self.init", self.start_state)

        for h_act in range(num_human_actions):
    ...
    def compute_max_robot_reward(self):
        # print("policy", policy)
